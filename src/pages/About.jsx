...
export default function About() {
    ...
    return (
      <section
        id="about"
        className="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-28 py-24 
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="flex-1 space-y-8 md:pl-16 text-center md:text-left"
        >
