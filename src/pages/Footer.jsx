    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-4">
          <a
           href="/Sajjad-CV.pdf" // Ab ye direct public folder se uthaye ga
           target="_blank"
           rel="noopener noreferrer"
           download="\Sajjad-CV.pdf" // Isse click karte hi download start ho jayegi
      ...
      >
        <div className="relative w-64 h-64 md:w-[450px] md:h-[450px]">
          ...
          {/* ✅ EXPERIENCE TAG: Mobile + Desktop Responsive */}
          <div className="absolute inset-0 animate-[spin_15s_linear_infinite] z-20 pointer-events-none">
            ...
            {/* --- 360° Rotating Tech Icons (4 Icons - Slow 60s Orbit) --- */}
{/* --- 360° Rotating Tech Icons (4 Icons - Super Slow 90s Orbit) --- */}
{[
  {
    name: "HTML",
